...
public class SwitchDownSide : MonoBehaviour
{
    ...
    private void Update()
    {
        if (isTriggered)
        {
            if (Input.GetKeyDown(KeyCode.F) && Elevator.GetComponent<ElevatorControl>().isUp)
            {
    ...
    //{
    //    if (Elevator.GetComponent<ElevatorControl>().isDown)
    //    {
